...
class Test_window(QWidget):
    def __init__(self, parent = None , model_path = "C:\\Users\\Mohamed-PC\\PycharmProjects\\graduation_project\\ELA_Model.h5" ):
        super().__init__()
    ...
    def init_window(self):
        ...
        for file in os.listdir('C:/Users/user1/Desktop/recolred_img_detection/final proj/UI/Re_Traind_Models'):
            self.combo.addItem(file.split('.')[0])
    ...
    def on_click(self):
        if self.file_path == "":
            ...
            if str(self.combo.currentText()) == "Error Level Analysis":
                model = "C:/Users/user1/Desktop/recolred_img_detection/final proj/UI/rec_dec_final.h5"
                ...
                path='C:/Users/user1/Desktop/recolred_img_detection/final proj/UI/Re_Traind_Models/'
                model=path+model+'.h5'
                self.myThread = Thread()
                label, prob = self.myThread.test_image_with_ela(self.file_path, model_path=model)
                self.myThread.start()
